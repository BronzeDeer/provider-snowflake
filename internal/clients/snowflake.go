...
import (
	...
	clusterv1beta1 "github.com/BronzeDeer/provider-snowflake/apis/cluster/v1beta1"
	namespacedv1beta1 "github.com/BronzeDeer/provider-snowflake/apis/namespaced/v1beta1"
)
...
func TerraformSetupBuilder(version, providerSource, providerVersion string) terraform.SetupFn {
	return func(ctx context.Context, client client.Client, mg resource.Managed) (terraform.Setup, error) {
		...
		//TODO: properly validate all different ways of identifying to the terraform provider and give good error messages back

...
type UserInitParameters struct {
	...
	// +crossplane:generate:reference:type=github.com/BronzeDeer/provider-snowflake/apis/cluster/rbac/v1alpha1.AccountRole
	DefaultRole *string `json:"defaultRole,omitempty" tf:"default_role,omitempty"`

	// Reference to a AccountRole in rbac to populate defaultRole.
	// +kubebuilder:validation:Optional
	DefaultRoleRef *v1.Reference `json:"defaultRoleRef,omitempty" tf:"-"`

	// Selector for a AccountRole in rbac to populate defaultRole.
	// +kubebuilder:validation:Optional
	DefaultRoleSelector *v1.Selector `json:"defaultRoleSelector,omitempty" tf:"-"`
	...
	// +crossplane:generate:reference:type=github.com/BronzeDeer/provider-snowflake/apis/cluster/warehouse/v1alpha1.Warehouse
	DefaultWarehouse *string `json:"defaultWarehouse,omitempty" tf:"default_warehouse,omitempty"`

	// Reference to a Warehouse in warehouse to populate defaultWarehouse.
	// +kubebuilder:validation:Optional
	DefaultWarehouseRef *v1.Reference `json:"defaultWarehouseRef,omitempty" tf:"-"`

	// Selector for a Warehouse in warehouse to populate defaultWarehouse.
	// +kubebuilder:validation:Optional
	DefaultWarehouseSelector *v1.Selector `json:"defaultWarehouseSelector,omitempty" tf:"-"`
